...

  {
    ...
    children: [
...

      {
        ...
        component: RouteView,
        meta: { title: '销售设置', keepAlive: true, icon: bxAnaalyse },
        children: [
          {
            path: '/sale/product',
            name: 'ProductSetting',
...

      {
        ...
        meta: { title: '客户管理', keepAlive: true, icon: bxAnaalyse },
        children: [
          {
...

      {
        ...
        component: RouteView,
        meta: { title: '订单管理', keepAlive: true, icon: bxAnaalyse },
        children: [
          {
            path: '/orders/big-lucky-star',
            name: 'BigLuckyStar',
            component: () => import('@/views/order/BigLuckyStar'),
            meta: { title: '大福星', keepAlive: false, permission: [ 'dashboard' ] }
          }
        ]
      },
